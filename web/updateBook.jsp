       ...
       <!-- Sidebar -->
        ...
        <div  class="w3-main" style="margin-left:250px">
            ...
            <div class="w3-row w3-padding-64">
                <br/>                <div class="w3-twothird w3-container">
                    ...
                    <form method="POST" action="manageBook" onsubmit="return confirm('Are you sure to Update Book details?')">
                       ...
                       <%int count = Integer.parseInt(request.getParameter("bookCount").toString());%> 
                        ...
                        <br/>
                        <p><button class="w3-button w3-block w3-gray w3-left-align" type="submit"><i class="fa fa-edit w3-margin-right"></i> Update Book </button></p>
