        ...
        <div  class="w3-main" style="margin-left:250px">
            ...
            <div class="w3-row w3-padding-64">
                ...
                <div class="w3-twothird w3-container">
                    ...
                    <form method="POST" action="issueBook" onsubmit="return confirm('Are you sure to Issue this Book?')">

                        <p><label><i class="fa fa-circle"></i> Book Id</label></p>
                        <input class="w3-input w3-border" type="text" name="bookId" required>     

                        <p><label><i class="fa fa-circle"></i> Member ID </label></p>
                        <input class="w3-input w3-border" type="test" name="memberId" required>

                        

                        <br/>
                        <p><button class="w3-button w3-block w3-gray w3-left-align" type="submit"><i class="fa fa-edit w3-margin-right"></i> Issue </button></p>
