        ...
        <div  class="w3-main" style="margin-left:250px">
            ...
            <div class="w3-row w3-padding-64">
                <div class="w3-twothird w3-container">
                    <br/>
                    <h1>Member Sign Up<br/></h1>

                    <form method="POST" action="addUser" onsubmit="return confirm('Are you sure to add Account?')">

                        <p><label><i class="fa fa-circle"></i> Name</label></p></li>
                        <input class="w3-input w3-border" type="text" name="name" required>     

                        <p><label><i class="fa fa-circle"></i> Address</label></p></li>
                        <input class="w3-input w3-border" type="text" name="address" required>  

                        <p><label><i class="fa fa-circle"></i> Phone Number</label></p></li>
                        <input class="w3-input w3-border" type="text" minlength="10" maxlength="10" name="phone" required>

                        <p><label><i class="fa fa-circle"></i> Login User Name</label></p></li>
                        <input class="w3-input w3-border" type="text" name="userName" required>     

                        <p><label><i class="fa fa-circle"></i> Login Password </label></p></li>
                        <input class="w3-input w3-border" type="password" name="password" required>

                        <br/>
                        <p><button class="w3-button w3-block w3-gray w3-left-align" type="submit" ><i class="fa fa-sign-in w3-margin-right"></i> Register </button></p>
